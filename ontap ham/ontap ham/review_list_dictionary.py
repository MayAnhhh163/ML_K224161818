...
dataset.append({"id":2,"name":"thuốc trị mụn","price":100})
...
sort_data()
print("Danh sách sp sau khi sắp xếp giá tăng dần:")
print_data()
...
add_product()
print("Danh sách sp sau khi nhập mới")
print_data()

dataset[0]={"id":163,"name":"Thuốc cảm","price":20}
print("Danh sách sp sau khi cập nhật")
print_data()

dataset.pop(1)
print("Danh sách sp sau khi xóa")
print_data()